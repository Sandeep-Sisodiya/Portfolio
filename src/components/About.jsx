...
export default function About() {
    ...
    return (
        <section id="about" className="section" ref={ref}>
            ...
            <motion.div {...fadeUp(0.1)} className="space-y-5 text-base text-body leading-relaxed max-w-3xl mt-2">
                <p>
                ...
                <p>
                    With a strong foundation in <span className="text-heading font-semibold">Data Structures & Algorithms</span>, Operating Systems, DBMS, and System Design, I approach every problem with a logical and performance-driven mindset.
                </p>
                <p>
            ...
            <motion.div {...fadeUp(0.15)} className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-10">
                {[
                    ...
                    <div key={i} className="card">
                        ...
                        <p className="text-base text-heading font-semibold">{item.value}</p>
                    </div>
                ))}
            </motion.div>
        </section>
