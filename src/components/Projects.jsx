                ...
                {projects.map((project, i) => (
                    ...
                    >
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                <h3 className="text-lg font-bold text-heading tracking-tight">{project.name}</h3>
                                <p className="text-sm text-body mt-1.5 leading-relaxed">{project.desc}</p>
                            </div>
                        </div>
                        ...
                        <a href={project.github} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1.5 text-sm text-muted hover:text-accent transition-colors duration-200 font-medium">
