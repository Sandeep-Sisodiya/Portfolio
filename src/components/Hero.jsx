            ...
            >
                ...
                <div className="space-y-4 text-base md:text-lg text-body leading-relaxed">
                    <p>
                        ...
                        <span className="text-heading font-semibold">Flutter</span>, Dart, Node.js, Firebase, and scalable architectures.
                    </p>
                    <p>
                        Strong foundation in <span className="text-heading font-semibold">Data Structures & Algorithms</span> in Java,
                    ...
                    <p>
                        ...
                        KIET Group of Institutions with an <span className="text-accent font-bold">8.20 GPA</span>,
                        passionate about building robust mobile applications and cloud-backed platforms.
                    </p>
                </div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-10">
                    {[
                        { label: 'Specialization', value: 'Android & Flutter' },
                        { label: 'Full-Stack', value: 'Node.js & MongoDB' },
                        { label: 'Strength', value: 'DSA in Java' },
                        { label: 'Cloud & AI', value: 'AWS & Gemini API' },
                    ].map((item, i) => (
                        <motion.div
                            key={i}
