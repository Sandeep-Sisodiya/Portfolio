...
export default function Contact() {
    ...
    const inputClass = "w-full px-4 py-3 bg-bg border border-border-color rounded-md text-heading text-sm placeholder:text-muted focus:border-accent focus:outline-none transition-colors"
            ...
            <div className="grid grid-cols-1 md:grid-cols-[1fr_240px] gap-8">
                ...
                >
                    <div className="card">
                        ...
                        <a href="mailto:sandeep@example.com" className="text-sm text-heading font-medium hover:text-accent transition-colors break-all">
                            sandeep@example.com
                        </a>
                    </div>
